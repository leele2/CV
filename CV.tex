...
\adjustbox{valign=t}{\begin{minipage}{11.3cm}
        ...
        \begin{itemize}
            \item Managed full-cycle bookkeeping, including reconciling accounts, uploading receipts and invoices (both digitally and physically), and maintaining financial records using Xero and Dext.
...
\adjustbox{valign=t}{%
    \begin{minipage}{7.3cm}
        ...
        % \faGit* Git,
        % \flag{R.png} R,
        % \flag{MatlabLogo.png} Matlab,
        % \faPython Python,

        \publication{Master Thesis}{2022}{Pricing Asian Options in Matlab}{Implemented a pricing model in \textsc{Matlab} and improved its efficiency by reducing the time complexity of the algorithm.}{https://github.com/leele2/Mathematics-in-Business-Project/blob/master/report.pdf}{View on Github}{\LaTeX,\flag{MatlabLogo.png},\faPython}

        \sectionspace

        \publication{End-of-year Project}{2020}{MHW and Their Effects on Phytoplankton}{Utilized R to analyze large satellite datasets, identifying marine heat waves and their effects on phytoplankton.}{https://github.com/leele2/Research-in-Mathematical-Sciences---CA3/blob/main/report.pdf}{View on Github}{\LaTeX,\flag{R.png},\faPython}
        ...
        \begin{multicols}{2}
            \begin{itemize}
                ...
                \item[\flag{bouldering.png}] Climbing
    ...
    \begin{minipage}{11.3cm}
        ...
        \begin{multicols}{2}
            ...
            \begin{itemize}
                ...
                \item \textbf{First-Generation University Graduate}: Broke new ground as the first in my family to attend university.
            \end{itemize}
        \end{multicols}
